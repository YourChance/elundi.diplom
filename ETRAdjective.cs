 ...
 * */
        ...
        protected RuMorf AnalyzeRuMorf(Slovo slovo)
        {
            ...
            */
            if (rus[rus.Length - 1] == 'я' && rus[rus.Length - 2] == 'с')
            {
                ok = rus.Substring(rus.Length - 4, 2);
                osn = rus.Substring(0, rus.Length - 4) + "ся";
            }
            else
            {
                    ...
                    case Vremya.Nastoyaschee:
                        switch (firstIndex)
                        {
                            case '1':
                                ...
                                {
                                    case '0':
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("молоть", "мелоть");
                                    ...
                                    case '2':
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("брить", "бреть");
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("петь", "поть");
                                        izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 2, 2);
                            ...
                            case '5':
                                if (slovo.zalog == Zalog.Dejstvitekniy)
                                {
                                    if (izmRuMorf.osnova[izmRuMorf.osnova.Length - 3] == 'а')
                                        izmRuMorf.okonchanie = "aщий";
                                    else
                                        izmRuMorf.okonchanie = "ящий";
                                    ...
                                    if (izmRuMorf.osnova.IndexOf("спать") != -1)
                                    {
                                        izmRuMorf.okonchanie = "ящий";
                                    }
                                    izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 3, 3);
                            ...
                            case '6':
                                if (slovo.zalog == Zalog.Dejstvitekniy)
                                {
                                    if (!zvezdochka)
                                    {
                                        if (secondIndex == 'а' || secondIndex == 'с')
                                        {
                                            ...
                                            if (izmRuMorf.osnova.IndexOf("ать") != -1)
                                            {
                                        ...
                                        if (secondIndex == 'в')
                                        {
                                            ...
                                            if (izmRuMorf.osnova.IndexOf("слaть") != -1)
                                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("сл", "шл");
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        izmRuMorf.okonchanie = "ущий";
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("брать", "берaть");
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("дрaть", "дерaть");
                                        izmRuMorf.osnova = izmRuMorf.osnova.Replace("звать", "зовaть");
                                        izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 3, 3);
                                    }
                                }
                                break;
                            ...
                            case '7':
                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("честь", "чт111");
                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("рaсти", "рaсти1");
                                izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 2, 2);
                                izmRuMorf.okonchanie = "ущий";
                                if (d_skobka)
                                {
                            ...
                            case '8':
                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("жечь", "ж11");
                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("толочь", "тол11");
                                izmRuMorf.osnova = izmRuMorf.osnova.Replace("мочь", "могь");
                                izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 1, 1);
                                izmRuMorf.okonchanie = "ущий";
                                if (g_skobka)
                                {
                        ...
                        switch (firstIndex)
                        {
                            ...
                            case '7':
                                if (izmRuMorf.osnova.IndexOf("рaсти") != -1)
                                    izmRuMorf.osnova = izmRuMorf.osnova.Replace("рaсти", "рос11");
                                izmRuMorf.okonchanie = "ший";
                                izmRuMorf.osnova = izmRuMorf.osnova.Remove(izmRuMorf.osnova.Length - 2, 2);
                                if (!b_b && d_skobka)
                                {
